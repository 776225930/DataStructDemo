package com.jhao.generic.wildchar;

import com.jhao.generic.Genertor;
import com.jhao.generic.wildchar.Fruit;
import com.jhao.generic.wildchar.GenericType;
import com.jhao.generic.wildchar.Orange;
...
public class WildChar {
    ...
    public static void use2() {
        ...
        GenericType<? super Fruit> d = new GenericType<Fruit>();
        GenericType<? super Fruit> e = new GenericType<Object>();
        print2(b);
        //print2(new GenericType<Food>());
        GenericType<? extends Fruit> c1 = new GenericType<>();
